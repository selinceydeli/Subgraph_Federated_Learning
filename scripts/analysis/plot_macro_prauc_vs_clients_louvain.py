...
MACRO_PRAUC = {
    ...
    "FedAvg + Fwd-LE":        [95.44, 92.84, 86.79, 84.22],
    "FedAvg + Fwd/Bwd-LE":    [95.14, 92.39, 86.53, 84.75],
    "Sync-SGD + Fwd-LE":      [97.13, 96.23, 94.98, 94.02],
    "Sync-SGD + Fwd/Bwd-LE":  [97.28, 95.95, 95.06, 94.25],
}
