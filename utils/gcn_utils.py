...
Acknowledgement
---------------
This module is adapted from IBM's Pattern-GNN repository:
    https://github.com/IBM/Pattern-GNN/blob/main/utils/gcn_utils.py

All credit for the original implementation belongs to the IBM Pattern-GNN
authors. It is reused here under the terms of the upstream repository's
license; please refer to the original repository for full license details.

Description
-----------
Utility functions for GNN data preprocessing (z-score / L2 normalization,
port and time-delta features, reverse-edge augmentation), loss-function
selection, and construction of induced subgraphs from a chosen list of
node indices.
"""
